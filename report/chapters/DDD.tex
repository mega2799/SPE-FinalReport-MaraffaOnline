...
\begin{itemize}
    \item Permette una distinta separazione dei buonded context e quindi di business logic e responsabilità. Questo permette ai servizi di essere il più indipendenti possibili
    e di evolvere in modo indipendente, aggiornando il sistema.
    \item Ove possibile ogni bounded context è stato sviluppato in un microservizio separato, in modo da garantire la massima indipendenza e scalabilità. Mantendo una chiara definizione 
    del dominio e delle proprie responsabilità di business.
    ...
    \item La manutentabilità dei singoli componenti che possono, ipoteticamente, essere sviluppati da team diversi in modo parallelo definendo al meglio i confini del dominio.
\end{itemize}
