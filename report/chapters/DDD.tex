...
Per poter mantere le varie parti di software evolvibili assieme al contesto e l'architettura che utilizza un servizio che "coordina" ed interroga gli altri e che ha il ruolo di customer
si utilizzerà il \textbf{Customer-supplier}, 
