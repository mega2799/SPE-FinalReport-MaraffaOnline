...
Come strumeto di controllo di versione è stato scelto git, sono state adottate le seguenti best practices o git policy per garantire un flusso di lavoro coerente e prevenire conflitti di merge.
...
la scelta è stata quella di utilizzare il merge per mantenere una storia del codice più pulita e lineare.
